...
class MandatPerpres extends Migration
{
    /**
     * Run the migrations.
     *
     ...
     public function up()
    {
        //
          ...
          Schema::create('ikb_perpres', function (Blueprint $table) {
            ...
            $table->unique(['id_urusan','id_sub_urusan','id_mandat','uraian','tahun']);
    ...
    {
        //
        Schema::dropIfExists('ikb_perpres');
