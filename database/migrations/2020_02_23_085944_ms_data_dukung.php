...
class MsDataDukung extends Migration
{
    /**
     * Run the migrations.
     *
       ...
       public function up()
    {
        //
         ...
         Schema::create('ms_data_dukung', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->text('uraian');
            $table->bigInteger('id_ms_pokok')->unsigned();
            $table->bigInteger('id_ms')->unsigned();
            $table->bigInteger('id_ms_akar')->unsigned();
            ...
            $table->foreign('id_ms_akar')
              ->references('id')->on('ms_akar')
              ->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        //
        Schema::dropIfExists('ms_data_dukung');
