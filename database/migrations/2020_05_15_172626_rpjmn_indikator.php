...
class RpjmnIndikator extends Migration
{
    ...
    {
        //
         if(!Schema::hasTable('kebijakan.tb_2020_2024_rpjmn_indikator')){ 
          Schema::create('kebijakan.tb_2020_2024_rpjmn_indikator',function(Blueprint $table){
    ...
    {
        //
        Schema::dropIfExists('kebijakan.tb_2020_2024_rpjmn_indikator');
