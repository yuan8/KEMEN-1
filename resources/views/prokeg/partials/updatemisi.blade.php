...
<form action="{{route('prokeg.ubah.misi')}}" method="post">
	@csrf
...
Sasaran 
<textarea required="required" name="uraian" class="form-control" style="min-height: 150px;">{{$data->misi}}</textarea></div> <div class="form-group"><label class="checkbox-inline" style="min-width: 100px;">
</div>
