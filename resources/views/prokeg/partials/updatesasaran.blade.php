...
<form action="{{route('prokeg.ubah.sasaran')}}" method="post">
	@csrf
...
Misi 
<textarea required="required" name="uraian" class="form-control" style="min-height: 150px;">{{$data->sasaran}}</textarea></div> <div class="form-group"><label class="checkbox-inline" style="min-width: 100px;">
</div>
