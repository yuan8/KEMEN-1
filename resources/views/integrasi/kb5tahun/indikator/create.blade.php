<form action="{{route('int.kb5tahun.indikator.store',['id'=>$ak_kondisi['id'],'id_kondisi'=>$ak_kondisi['id_kondisi']])}}" method="post">
					...
					<div class="col-md-9">
						...
						<hr>
							<div class="row">
								<div class="col-md-4">
									<p><b>PUSAT</b></p>
									<input type="checkbox" target-toggle-checkbox-dss="#kw-nas-data-dukung-{{$domid}}" class="bt-toggle-init" name="kw_nas" data-toggle="toggle" data-on="BERWENANG" data-off="TIDAK " data-width="100%" data-size="small" data-onstyle="success" data-offstyle="danger">
									<div id="kw-nas-data-dukung-{{$domid}}" style="margin-top: 10px;">
										<label>DATA DUKUNG TERKAIT KEWENANGAN PUSAT</label>
										<textarea class="form-control "  name="data_dukung_nas"   style="min-height: 100px;" ></textarea>
									</div>
								</div>
								<div class="col-md-4">
									<p><b>PROVINSI</b></p>
									<input type="checkbox" target-toggle-checkbox-dss="#kw-p-data-dukung-{{$domid}}" class="bt-toggle-init" name="kw_p" data-toggle="toggle" data-on="BERWENANG" data-off="TIDAK " data-width="100%" data-size="small"  data-onstyle="success" data-offstyle="danger">
									<div id="kw-p-data-dukung-{{$domid}}" style="margin-top: 10px;">
										<label>DATA DUKUNG TERKAIT KEWENANGAN PROVINSI</label>
										<textarea class="form-control "  name="data_dukung_p"  style="min-height: 100px;" ></textarea>
									</div>
								</div>
								<div class="col-md-4">
									<p><b>KOTA/KABUPATEN</b></p>
									<input type="checkbox" target-toggle-checkbox-dss="#kw-k-data-dukung-{{$domid}}" class="bt-toggle-init" name="kw_k" data-toggle="toggle" data-on="BERWENANG" data-off="TIDAK " data-width="100%" data-size="small" data-onstyle="success" data-offstyle="danger">
									<div id="kw-k-data-dukung-{{$domid}}" style="margin-top: 10px;">
										<label>DATA DUKUNG TERKAIT KEWENANGAN KOTA/KAB</label>
										<textarea class="form-control " name="data_dukung_k" style="min-height: 100px;" ></textarea>
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-3">
							...
							<hr>
								...
								<br>
								<textarea class="form-control" name="pelaksana" required=""></textarea>
