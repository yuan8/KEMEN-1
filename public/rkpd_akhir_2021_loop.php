...
$sql="SELECT kodepemda FROM status_rkpd_akhir_2021 WHERE kodepemda NOT IN (SELECT kodepemda FROM master_program GROUP BY kodepemda) ";
...
$raw_data = file_get_contents('https://sipd.go.id/run/serv/get.php?tahun=2021&kodepemda='.$kodepemda.'', false, $context);
